...
1 <= piles[i] <= 109
 */
public class MQ875KokoEatingBananas {
    ...
    private static int numHours(int[] piles, int mid) {
     return Arrays.stream(piles).reduce(0,(subtotal,pile)->subtotal+(pile-1)/mid+1);
    }
